...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _startTest() {
    String seed =
        "daring phrase labor alien treat divert trick analyst shrug idle run program//kusama///";
    String suriSuffix = "//kusama";
    String seedPhrase =
        "daring phrase labor alien treat divert trick analyst shrug idle run program";
    ...
    String signedWithRefResult =
        substrateSignWithRef(seedRef, suriSuffix, message);
